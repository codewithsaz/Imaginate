  ...
  return (
    <>
      ...
      <div className="w-full h-full  flex flex-col items-center justify-center p-2">
        <div className=" lg:w-3/5 h-full flex flex-col items-center pt-10 gap-10">
          ...
          <p className="w-3/4 h-full text-center">
            ...
            Watch your imagination transform into AI-generated images online.
            Free text to image AI generator, save time on creating or searching
